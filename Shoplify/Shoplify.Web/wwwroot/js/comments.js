        ...
        for (var comment of comments) {
            commentsSection.innerHTML += 
                ...
                <div class="user-details d-flex align-items-center flex-wrap">
                    ...
                    <a href="/User/Profile?id=${comment.userId}&orderBy=dateDesc&page=1" class="view-btn color-2 reply order-2 order-sm-3"><i class="fa fa-reply" aria-hidden="true"></i><span>View Profile</span></a>
                </div>
