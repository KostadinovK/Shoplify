...
namespace Shoplify.Web.Data.Migrations
{
    ...
    [Migration("20200314115234_AddedIsArchivedByUserBoolsToConversationTable")]
    partial class AddedIsArchivedByUserBoolsToConversationTable
    {
            ...
            modelBuilder.Entity("Shoplify.Domain.Conversation", b =>
                {
                    ...
                    b.Property<bool>("IsArchivedByFirstUser")
                        .HasColumnType("bit");

                    b.Property<bool>("IsArchivedBySecondUser")
                        .HasColumnType("bit");

                    b.Property<bool>("IsReadByFirstUser")
                        .HasColumnType("bit");

                    b.Property<bool>("IsReadBySecondUser")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Shoplify.Domain.Conversation", b =>
                {
                    ...
                    b.HasOne("Shoplify.Domain.User", "FirstUser")
                        .WithMany()
                        .HasForeignKey("FirstUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Shoplify.Domain.User", "SecondUser")
                        .WithMany()
